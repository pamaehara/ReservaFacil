...
public class TaxaBTest {
	...
	public void calculaTaxaTest() {
		Taxa taxa = new TaxaB();
		Agendamento agendamento = new Agendamento(1, "12345-0", "54321-0", BigDecimal.valueOf(100), null, null, TipoENUM.B, LocalDate.now());
	...
	public void calculaTaxaTest1() {
		Taxa taxa = new TaxaB();
		Agendamento agendamento = new Agendamento(1, "12345-0", "54321-0", BigDecimal.valueOf(100), null, null, TipoENUM.B, 
